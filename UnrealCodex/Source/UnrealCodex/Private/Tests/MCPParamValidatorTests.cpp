...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.ActorName.ValidNames",
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.ActorName.InvalidNames",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.ActorName.LengthLimits",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.ConsoleCommand.BlockedCommands",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.ConsoleCommand.ChainAttempts",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.ConsoleCommand.ValidCommands",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.BlueprintPath.Security",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.PropertyPath.Format",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.NumericValue.EdgeCases",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.SanitizeString.RemovesDangerousChars",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.MCP.ParamValidator.BlueprintNames.Validation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
