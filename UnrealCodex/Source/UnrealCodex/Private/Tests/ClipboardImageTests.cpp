...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.GetScreenshotDirectory.ReturnsValidPath",
...
bool FClipboardImage_GetScreenshotDirectory_ReturnsValidPath::RunTest(const FString& Parameters)
{
	...
	TestTrue("Should contain UnrealCodex", Dir.Contains(TEXT("UnrealCodex")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.Cleanup.DeletesOldFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Cleanup_DeletesOldFiles::RunTest(const FString& Parameters)
{
	...
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealCodex"), TEXT("test_screenshots"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.Cleanup.IgnoresNonClipboardFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_Cleanup_IgnoresNonClipboardFiles::RunTest(const FString& Parameters)
{
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealCodex"), TEXT("test_screenshots2"));
	IFileManager::Get().MakeDirectory(*TestDir, true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.Cleanup.HandlesNonExistentDirectory",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.Constants.ReasonableValues",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Constants_ReasonableValues::RunTest(const FString& Parameters)
{
	TestTrue("MaxScreenshotAgeSeconds should be positive",
		UnrealCodexConstants::ClipboardImage::MaxScreenshotAgeSeconds > 0.0);

	TestTrue("MaxScreenshotAgeSeconds should be at least 60 seconds",
		UnrealCodexConstants::ClipboardImage::MaxScreenshotAgeSeconds >= 60.0);

	TestTrue("ThumbnailSize should be positive",
		UnrealCodexConstants::ClipboardImage::ThumbnailSize > 0.0f);

	TestTrue("ThumbnailSize should be reasonable (16-256px)",
		UnrealCodexConstants::ClipboardImage::ThumbnailSize >= 16.0f &&
		UnrealCodexConstants::ClipboardImage::ThumbnailSize <= 256.0f);

	TestTrue("ScreenshotSubdirectory should not be null",
		UnrealCodexConstants::ClipboardImage::ScreenshotSubdirectory != nullptr);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.DataStructs.RequestConfigHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.DataStructs.PromptOptionsHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.DataStructs.ConvenienceConstructorPreservesDefaults",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.PathValidation.ScreenshotDirIsUnderSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.ClipboardHasImage.DoesNotCrash",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.FallbackToAssistantBlocks",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.HandleEmptyOutput",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.HandleMalformedJson",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.BuildPayloadWithImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.BuildPayloadRejectsInvalidPath",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.BuildPayloadWithoutImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.BuildPayloadRejectsTraversal",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.BuildPayloadRejectsOversizedImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.StreamJson.ParseFailureReturnsErrorMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.BuildPayloadWithMultipleImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.BuildPayloadRespectsMaxCount",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_MultiImage_BuildPayloadRespectsMaxCount::RunTest(const FString& Parameters)
{
	...
	TestEqual("Should have 6 content blocks (1 text + 5 images, capped)",
		BlockCount, 1 + UnrealCodexConstants::ClipboardImage::MaxImagesPerMessage);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.BuildPayloadSkipsInvalidImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.BuildPayloadTotalSizeGuard",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.BuildPayloadMixedValidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.ConstantsMaxImagesReasonable",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.RequestConfigArrayOperations",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealCodex.ClipboardImage.MultiImage.PromptOptionsArrayCopied",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
