...
TSharedPtr<FJsonObject> FMCPTool_Character::CharacterToJson(ACharacter* Character, bool bIncludeMovement)
{
	...
	// Transform
	Json->SetObjectField(TEXT("location"), UnrealCodexJsonUtils::VectorToJson(Character->GetActorLocation()));
	Json->SetObjectField(TEXT("rotation"), UnrealCodexJsonUtils::RotatorToJson(Character->GetActorRotation()));
...
TSharedPtr<FJsonObject> FMCPTool_Character::MovementComponentToJson(UCharacterMovementComponent* Movement)
{
	...
	Json->SetObjectField(TEXT("velocity"), UnrealCodexJsonUtils::VectorToJson(Movement->Velocity));
...
TSharedPtr<FJsonObject> FMCPTool_Character::ComponentToJson(UActorComponent* Component)
{
	...
	if (USceneComponent* SceneComp = Cast<USceneComponent>(Component))
	{
		...
		Json->SetObjectField(TEXT("relative_location"), UnrealCodexJsonUtils::VectorToJson(SceneComp->GetRelativeLocation()));
		Json->SetObjectField(TEXT("relative_rotation"), UnrealCodexJsonUtils::RotatorToJson(SceneComp->GetRelativeRotation()));
