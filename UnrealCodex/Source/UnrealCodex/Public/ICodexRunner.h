...
/**
 * Types of structured events from Codex stream-json NDJSON output.
 * Maps to the message types documented in the Codex CLI stream event format.
 */
...
/**
 * Structured event parsed from Codex CLI stream-json NDJSON output.
...
/**
 * Abstract interface for Codex CLI runners
...
public:
	...
	/**
	 * Execute a Codex CLI command asynchronously
	...
	/**
	 * Execute a Codex CLI command synchronously (blocking)
	 * @param Config - Request configuration
